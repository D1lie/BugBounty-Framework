...
function App() {
  ...
  return (
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              ...
              <div style={{ display: 'flex', alignItems: 'center', marginTop: '10px' }}>
                ...
                />
                <span style={{ color: 'green' }}>Scan only selected domain</span>
              </div>
            </li>
            <li className="nav-item ml-5">
            <h3 style={{ color: 'green' }}>Data Export</h3>
            ...
            <div>
              <label style={{ color: 'green' }}>
                <h3 style={{ color: 'green' }}>Data Import</h3>
    ...
    <div className="pl-3 p-2 navbar navbar-expand-lg bg-dark" style={{ overflow: 'auto', whiteSpace: 'nowrap' }}>
      <span style={{ display: 'block', padding: '15px', color: '#106100', width: '250px'}}>
          Core Module: {coreModule}<br></br>
          Target Domain: {scanDomain}
      </span>
      <span style={{ display: 'block', padding: '15px', color: '#106100', width: '350px'}}>
      ...
      <label style={{padding: '15px', color: '#106100'}} for="checkbox1">Fire-Starter</label>
      ...
      <label style={{padding: '15px', color: '#106100'}} for="checkbox2">Fire-Cloud</label>
      ...
      <label style={{padding: '15px', color: '#106100'}} for="checkbox3">Fire-Scanner</label>
      ...
      <label style={{padding: '15px', color: '#106100', textDecoration: 'line-through'}} for="checkbox2">Fire-Spreadder</label>
      ...
      <label style={{padding: '15px', color: '#106100', textDecoration: 'line-through'}} for="checkbox2">Fire-Enumeration</label>
